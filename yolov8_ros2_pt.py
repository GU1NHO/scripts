...
class Camera_subscriber(Node):  
    ...
    def __init__(self):
        ...
        self.model = YOLO('~/yolobot/src/yolobot_recognition/scripts/best.onnx')
    ...
    def camera_callback(self, data):
        ...
        # m = onnx.load("~/yolobot/src/yolobot_recognition/scripts/best.onnx")
        # props = {p.key : p.value for p in m.metadata_props}
        # if "names" in props:
        #     self.inference_result.class_name = ast.literal_eval(props["names"])
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                c = box.cls
                self.inference_result.class_name = "inferencia"
